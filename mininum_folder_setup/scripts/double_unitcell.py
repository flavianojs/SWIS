...
outputfile = "inputfiles/pair_Mn5Ge3_temp_double.txt"

#Initial basis
num_atom_basis_ini = 2

a1_ini       = np.array([ 1.0             ,  0.0              ,  0.0 ])
a2_ini       = np.array([-0.5             ,  0.866025403784439,  0.0 ])
a3_ini       = np.array([ 0.0             ,  0.0              ,  1.0 ])

basis_ini    = np.zeros((num_atom_basis_ini,3),      dtype=np.float64)
basis_ini[0] = np.array([ 0.0,  0.0,  0.00])
basis_ini[1] = np.array([ 0.333333333333,  0.666666666666,  0.00 ])

#Final basis
num_atom_basis_fin = 4

a1_fin       = np.array([ 2.0             ,  0.0              ,  0.0 ])
a2_fin       = np.array([-0.5             ,  0.866025403784439,  0.0 ])
a3_fin       = np.array([ 0.0             ,  0.0              ,  1.0 ])

basis_fin    = np.zeros((num_atom_basis_fin,3),      dtype=np.float64)
basis_fin[0] = np.array([  0.0,             0.0,             0.00 ])
basis_fin[1] = np.array([  0.166666666666,  0.666666666666,  0.00 ])
basis_fin[2] = np.array([  0.5,             0.0,             0.00 ])
basis_fin[3] = np.array([  0.666666666666,  0.666666666666,  0.00 ])
